            ...
            <div class="shadow overflow-hidden sm:rounded-md">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h2 class="font-semibold mb-5 text-xl leading-tight">
                        @role('sadmin|admin')
                        Permintaan Surat, {{$data->mahasiswas->name}}
                        @endrole
                        @role('mahasiswa')
                        Hasil Permintaan Surat, {{auth()->user()->name}}
                        @endrole
                    </h2>
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            @if(isset($data->outgoings->file_path) && $data->outgoings->file_path != config('app.url') . '/storage/')
                            <tr>
                                <th class="border px-6 py-4 text-left">Attachment *PDF</th>
                                <td class="border px-6 py-4">
                                    <button data-modal-target="outgoing-file" data-modal-toggle="outgoing-file" class="inline-block border border-gray-700 bg-gray-700 text-white rounded-md px-2 py-1 m-1 transition duration-500 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline py-2" type="button">
                                        Show Document
                                    </button>
                                </td>
                            </tr>
                            @endif
                            @if($data->outgoings->is_approve == true)
                            <tr>
                                    ...
                                    <div class="relative w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 space-y-6">
                                                <iframe src="{{ route('incoming.show-reply',base64_encode($data->reference_number)) }}" class="w-full h-screen"></iframe>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 mt-5">
                            <div class="w-full px-3 text-right">
                                <button id="dropdownHelperRadioButton" data-dropdown-toggle="dropdownHelperRadio" class="text-right text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" required>
                                    Tanggapi Surat <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        ...
                        <div id="dropdownHelperRadio" class="mt-10 z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style="inset: auto auto 0px 0px; margin: 0px; transform: translate3d(522.5px, 6119.5px, 0px);" required>
                            <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHelperRadioButton">
                                <li>
                                    <div class="flex p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600" required>
                                        <div class="flex items-center h-5">
                                            <input id="radio-helper-4" name="status" type="radio" value="VALIDATE" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" required>
                                        </div>
                                ...
                                <li>
                                    <div class="flex p-2 rounded hover-bg-gray-100 dark-hover-bg-gray-600" required>
                                        <div class="flex items-center h-5">
                                            <input id="radio-helper-5" name="status" type="radio" value="REJECT" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark-bg-gray-600 dark-border-gray-500" required>
                                        </div>
                                        <div class="ml-2 text-sm">
                                                        ...
                                                        <div class="p-6 space-y-6">
                                                            <div class="flex flex-wrap -mx-3 mb-6">
                                                                <div class="w-full px-3">
                                                                    ...
                                                                    <input name="no_surat" type="text" class="w-full dark:bg-gray-200 dark:text-gray-700 text-gray-700 border border-gray-200 dark:border-gray-700 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="file"> </div>
                                                            </div>
                                                            <div class="flex flex-wrap -mx-3 mb-6">
                                                                <input type="hidden" name="ref_number" value="{{$data->reference_number}}">
                                                                <input type="hidden" name="status" value="{{auth()->user()->identifier}}">
                                                                <div class="w-full px-3">
                                                                    <label class="block uppercase tracking-wide text-gray-700 dark:text-gray-300 text-xs font-bold mb-2" for="note">
                                                                        Note
                                                                    </label>
                                                            ...
                                                            <div class="flex flex-wrap -mx-3 mb-6 p-4 space-y-4">
                                                                ...
                                                                <ul class="grid w-full gap-6 md:grid-cols-2">
                                                                    <li>
                                                                        <input type="radio" id="status-small" name="status" value="APPROVE" class="hidden peer" required>
                                                                    ...
                                                                    <li>
                                                                        <input type="radio" id="status-big" name="status" value="REJECT" class="hidden peer">
